...
describe('Protractor Demo App',  function() {
  it('should start run on chrome', function(){
    ...
    // it('should pass after everything ok',async function(){
      // browser.ignoreSynchronization = true;
      // browser.get('http://localhost:8080/');
      // element(by.id("date")).sendKeys("23/07/2023");
      ...
      // element(by.id("phone")).sendKeys("1234567890");
    ...
    //   // element(by.id("add-course")).click();
    //   //    element(by.id(`AddsubjectCode1`)).sendKeys("MA212");
    //   //   element(by.id(`AddsubjectName1`)).sendKeys("Calculus 2");
    //   //   element(by.id(`AddsubjectSection1`)).sendKeys("870001");
    //   //   element(by.id(`AddsubjectDate1`)).sendKeys("tue,ths");
    //   //   element(by.id(`AddsubjectCredit1`)).sendKeys("3");
    //   //   element(by.id(`AddsubjectTeacher1`)).sendKeys("ajarn aek");
    //   //   let check = Math.random() > 0.5;
    //   //   if(check){
    //   //     element(by.id(`AddsubjectTeacherCheck1`)).click();
    //   //   }
